        ...
        <div class="content">
            ...
            <div class="gallery-container">
                ...
                $categories = get_categories(array(
                    'child_of' => '5', //IDが4のカテゴリーの子カテゴリーを読み込む
                ...
                ?>
                    <a href="<?php echo get_category_link($category->term_id); ?>" class="gallery" style="background-color: <?php the_field('gallery-theme-color', $post_id); ?>">
